...
public class NetworkConnectionUtils {
    ...
    public static void connectWifiSSID(Context context, WifiManager manager, String ssid, String
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            new com.example.baseactivitysdk.utils.utils.WifiAutoConnectManager(manager).connect(ssid, password, com.example.baseactivitysdk.utils.utils.WifiAutoConnectManager
