...
public class SpUtils {
    ...
    public static <T> void setDataList(String key, List<T> datalist) {
        ...
        SpUtils.putString(com.example.baseactivitysdk.utils.utils.AppUtils.getContext(), key, strJson);
    }
    ...
    public static <T> List<T> getDataList(String key, Class<T> cls) {
        ...
        String strJson = SpUtils.getString(com.example.baseactivitysdk.utils.utils.AppUtils.getContext(), key, null);
