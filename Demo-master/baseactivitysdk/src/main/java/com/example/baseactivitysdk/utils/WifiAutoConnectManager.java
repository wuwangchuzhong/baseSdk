...
public class WifiAutoConnectManager {
    ...
    private WifiConfiguration createWifiInfo(String SSID, String Password,
        ...
        if (Type == WifiCipherType.WIFICIPHER_WEP) {
            if (!com.example.baseactivitysdk.utils.utils.StringUtils.isEmpty(Password)) {
    ...
    public static WifiCipherType getCipherType(Context context, String ssid) {
        ...
        for (ScanResult scResult : list) {
            ...
            if (!com.example.baseactivitysdk.utils.utils.StringUtils.isEmpty(scResult.SSID) && scResult.SSID.equals(ssid)) {
                String capabilities = scResult.capabilities;

                if (!com.example.baseactivitysdk.utils.utils.StringUtils.isEmpty(capabilities)) {
